...
<!--面包屑导航-->
  <ol class="breadcrumb"> 
    ...
    <li style="color: rgb(0, 0, 0);" class="active">公司通告</li>
  </ol>
<!--面包屑导航-->
<!--表单-->
        ...
        <table class="table table-hover table-bordered">
            ...
            <c:forEach items="${noticelist}" var="message">
				<tr style="background-color:#EEEEEE;color: rgb(0, 0, 0);">
	                ...
	                <th><a href="notice/detail?id=${message.id}">详情</a>|<a onclick="return confirm('你确定删除吗');" href="notice/delete?id=${message.id}" >删除</a></th>
